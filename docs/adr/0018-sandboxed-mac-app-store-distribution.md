...
- superseded_by: 0020, 0030
- superseded_scope: 0020=direct_release_identifier_namespace;0030=worker_transient_bookmark_staleness
- supersedes: 0013
...
ADR [0030](0030-identity-bound-store-bookmark-renewal.md) supersedes only
unconditional stale rejection for current-attempt worker transient grants with
verified identity and one bounded in-memory renewal. Persistent agent source
authorization and all other scope boundaries remain unchanged.
