-- Full canonical video is required for moderation beyond the 30-second teaser.
-- Thumbnail output is never part of the private review contract.
-- Keep the newest-first timestamp/UUID cursor consistent with UUID ascending order.
