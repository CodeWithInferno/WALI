-- Approved submissions remain available to authorized native operators for publication.
-- Keep the same bounded private projection and server role/AAL checks.
