...
/usr/bin/ruby "${ROOT_DIR}/Tests/Release/production-config-tests.rb"
...
/usr/bin/ruby "${ROOT_DIR}/Tests/Release/ci-release-tests.rb"
python3 -B "${ROOT_DIR}/Tests/Release/media-license-tests.py"
